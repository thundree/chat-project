...
export const initialChatList: Chat[] = [
  ...
  },
  {
    ...
    temperature: 0.5,
    characterConversationBase: "The wise lord of Rivendell.",
    characterColor: "",
    characterVoice: "Male",
    backgroundImage: "https://files.catbox.moe/kgzu7v.jpg",
    messages: [
